...
* **Ver os namespaces existentes**: kubectl get namespaces  
* **Criar um namespace**: kubectl create namespaces  
* **Deletar um namespace**: kubectl delete namespaces  
* **Definir um namespace como padrão**: kubectl config set-context --current --namespace=  
